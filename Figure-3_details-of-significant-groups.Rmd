...
```{r}
abxclasses <- c("BetaLactam", "Macrolide",  "Other.Antibacterial", "Fluoroquinolone", "Tetracycline", "Vancomycin", "Sulfamethoxazole", "Clindamycin", "Metronidazole")
...
alcancster.hr <- lapply(allcancers, function(x)  coefficients(summary(coxph(Surv(days, vitalstatus) ~ ster.28.28, data = filter(db, cancer.name == x))))[,2])
...
```{r}
heatplot <- heatclass %>%
  ggplot(aes(fct_relevel(AbxClass, "All", "Antibacterial", "Antifungal", "Antiviral", bacorder), fct_relevel(cancer, "Other", "Bladder Cancer", "Head and Neck Carcinoma", "Melanoma", "Non-Small Cell Lung Cancer", "Renal Cell Carcinoma", "Sarcoma", "All"))) +
  ...
  scale_x_discrete(breaks = c("All", "Antifungal", "Antiviral", "Antibacterial", "BetaLactam", "Macrolide",  "Other.Antibacterial", "Fluoroquinolone", "Tetracycline", "Vancomycin", "Sulfamethoxazole", "Clindamycin", "Metronidazole"), labels =c("All", "Antifungal", "Antiviral", "Antibacterial", "BetaLactam", "Macrolide",  "Linezolid", "Fluoroquinolone", "Tetracycline", "Vancomycin", "Sulfamethoxazole-TMP", "Clindamycin", "Metronidazole")) +
...
# This is done to fill in NA's, will need to be changed if data changes
rankinghrs$Linezolid <- c(9,9,9,9,9,1,3)
rankinghrs$Metronidazole <- c(7,8,4,2,7,8,8)
rankinghrs$Sulfamethoxazole <- c(3,6,4,3,2,7,8)
rankinghrs$Tetracycline <- c(1,2,8,2,8,8,4)
```
