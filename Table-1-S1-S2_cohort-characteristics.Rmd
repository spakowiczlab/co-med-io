...
```{r table 1}
listVars <- c("BMI", "Age", "Sex", "ECOG PS", "Cancer", "Staging", "Immunotherapy",
              "ATB within 28 days of ICI", "CS within 28 days of ICI")
catVars <- c("Sex", "Cancer", "Immunotherapy", "ECOG PS", "Staging", 
             "ATB within 28 days of ICI", "CS within 28 days of ICI")
...
```{r}
listVars <- c("BMI", "Age", "Sex", "ECOG PS", "Cancer", "Staging", 
