...
```{r table 1}
listVars <- c("BMI", "Age", "Sex", "ECOG", "CCI", "Cancer", "Staging", "Immunotherapy", "ATB within 28 days of ICI", "CS within 28 days of ICI")
catVars <- c("Sex", "Cancer", "Immunotherapy", "ECOG", "Staging", "ATB within 28 days of ICI", "CS within 28 days of ICI", "CCI")
