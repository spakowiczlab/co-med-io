...
ggplot(data = sterpvaltime, aes(x = leftanchor, y = hazard.ratio)) +
  ...
  labs(title = "", x = "Days relative to IO start",y = "Hazard Ratio" ) +
  theme_bw() + 
...
heatplot <- heatclass %>%
  ...
  scale_shape_manual(breaks = c("black", "red"), values = c("-", "+"), labels = c("Negative effect on OS", "Positive effect on OS"), name = "Direction") +
  labs(x = "", y = "") +
